...
func PickMost(c *ControlPlane, machines util.FilterableMachineCollection) *string {
...
func orderDescending(failureDomains clusterv1.FailureDomains, machines util.FilterableMachineCollection) failureDomainAggregations {
...
func PickFewest(failureDomains clusterv1.FailureDomains, machines util.FilterableMachineCollection) *string {
	aggregations := pick(failureDomains, machines)
	if len(aggregations) == 0 {
		return nil
	}
...
func pick(failureDomains clusterv1.FailureDomains, machines util.FilterableMachineCollection) failureDomainAggregations {
